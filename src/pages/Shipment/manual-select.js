...
function DoSelectManual() {
  ...
  const handleManual = async () => {
    ...
    navigate('/pengiriman/otomatisasi')  // Arahkan ke halaman /pe
      ...
      <div className="w-full  mx-auto space-y-5 mt-4 visible pt-10 px-10">
            ...
            <div className="mt-4">
              ...
              <div className="relative w-full">
                <select
                  ...
                  className="border rounded-lg p-2 px-16 py-2" // Mengatur lebar ke 50% dari kontainer
                >
                  ...
                  {dataTruk.map((truck) => (
                    <option key={truck.id} value={truck.id}>
                      {truck.plate_number} [{truck.truck_type.name}]
                    </option>
                  ))}
                </select>
              </div>
        ...
        <div className="flex justify-end w-full">
            <button
              ...
              disabled={!selectedTruck || selectedDO.length === 0 || !selectedDate || !selectedStartDate || !selectedEndDate} // Nonaktifkan jika salah satu kosong
            >
